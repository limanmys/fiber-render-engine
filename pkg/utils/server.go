...
import (
	...
	"github.com/limanmys/render-engine/app/middleware/appLogger"
...
func CreateServer() {
	...
	// Start server
	logger.Sugar().Fatal(app.ListenTLS(":2806", constants.CERT_PATH+"/liman.crt", constants.CERT_PATH+"/liman.key"))
}
